...
import {check_username, compare, titleCase} from '../util/CountryUtils'
...
class Country extends Component {
    ...
    render() {
        const isRender = this.state.render;
        if (!isRender) {
            return (
                <>
                        ...
                        <Grid container>
                            <Grid item xs={12}>
                                <Paper className={["p-3"]}>
                                    ...
                                    <Typography variant="h6" gutterBottom>Active users
                                        from {titleCase(this.props.match.params.name)}</Typography>
                                    <div className="table-responsive">
                                        ...
                                        <table className="table table-borderless">
                                            ...
                                            <tbody>
                                            {this.limit(this.state.data.sort(compare)).map((item, key) => {
                                                return <tr key={key} className="border-bottom">
                                                    ...
                                                    <td className="align-middle">
                                                        <a className="text-gray-dark text-black-50" target={'_blank'}
                                                           rel="noopener"
